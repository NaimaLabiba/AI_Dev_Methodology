...
class MethodologyManager {
    ...
    updateMethodologyTitle() {
        ...
        // Show SDD title if SDD is selected
        else if (selectedMethodology === 'sdd') {
            this.updateSDDTitle();
        }
    }
    ...
    updateSDDTitle() {
        // Remove existing SDD title if any
        this.removeSDDTitle();
        
        // Create SDD title element
        const sddTitle = document.createElement('div');
        sddTitle.id = 'sddTitle';
        sddTitle.className = 'sdd-title';
        sddTitle.innerHTML = `
            <div class="sdd-title-content">
                <span class="sdd-icon">📋</span>
                <span class="sdd-text">SDD</span>
                <span class="sdd-subtitle">Specification-Driven</span>
            </div>
        `;
        
        // Add to top right corner of the page
        document.body.appendChild(sddTitle);
    }
    
    removeSDDTitle() {
        const existingTitle = document.getElementById('sddTitle');
        if (existingTitle) {
            existingTitle.remove();
        }
    }
