...
class MethodologyManager {
    ...
    updateMethodologyTitle() {
        ...
        // Show DDD title if DDD is selected
        else if (selectedMethodology === 'ddd') {
            this.updateDDDTitle();
        }
    }
    ...
    updateDDDTitle() {
        // Remove existing DDD title if any
        this.removeDDDTitle();
        
        // Create DDD title element
        const dddTitle = document.createElement('div');
        dddTitle.id = 'dddTitle';
        dddTitle.className = 'ddd-title';
        dddTitle.innerHTML = `
            <div class="ddd-title-content">
                <span class="ddd-icon">🟠</span>
                <span class="ddd-text">DDD</span>
                <span class="ddd-subtitle">Domain-Driven Design</span>
            </div>
        `;
        
        // Add to top right corner of the page
        document.body.appendChild(dddTitle);
    }
    
    removeDDDTitle() {
        const existingTitle = document.getElementById('dddTitle');
        if (existingTitle) {
            existingTitle.remove();
        }
    }
